...
This folder defines all source code for the 'MoveDataToStg' pipeline:
...
* Take a look at the sample under "sample_users_movedatatostg.py" to get familiar with the syntax.
